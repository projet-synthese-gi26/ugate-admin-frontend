...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "bg-blue-600 text-white hover:bg-blue-700 shadow-sm hover:shadow-md hover:-translate-y-0.5 focus-visible:ring-blue-600/20",
    ...
    outline: "bg-transparent border border-blue-600 text-blue-600 hover:bg-blue-50 focus-visible:ring-blue-600/20"
  };
